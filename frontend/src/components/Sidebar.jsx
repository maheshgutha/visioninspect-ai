...
const qeLinks = [
  ...
  { to: "/inline-scanner", label: "In-Line Camera Scanner", icon: "📹" },
  ...
  return (
    <aside className="w-64 shrink-0 fixed left-0 top-0 h-screen overflow-y-auto bg-slate-900 text-slate-200 flex flex-col z-20">
      <div className="px-5 py-5 border-b border-slate-800">
        ...
        <p className="text-xs text-slate-400 mt-0.5">Manufacturing Quality Platform</p>
      </div>
